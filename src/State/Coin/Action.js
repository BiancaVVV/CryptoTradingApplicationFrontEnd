...
export const fetchCoinList = (page) => async (dispatch) => {
  ...
  export const fetchTopGainers = () => async (dispatch) => {
    ...
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/coins/gainers-losers`);

      dispatch({ type: FETCH_TOP_GAINERS_SUCCESS, payload: response.data });
    } catch (error) {
      dispatch({ type: FETCH_TOP_GAINERS_FAILURE, payload: error.message });
    }
  };
  ...
  export const fetchTopLosers = () => async (dispatch) => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/coins/gainers-losers`);
      dispatch({ type: FETCH_TOP_LOSERS_SUCCESS, payload: response.data });
    } catch (error) {
      dispatch({ type: FETCH_TOP_LOSERS_FAILURE, payload: error.message });
    }
  };
